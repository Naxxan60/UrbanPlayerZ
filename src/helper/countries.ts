...
export const COUNTRIES = [
    ...
    { code: "BN", label: "Brunéi Darussalam" },
    ...
    { code: "EA", label: "Ceuta et Melilla" },
    { code: "CL", label: "Chili" },
    { code: "CN", label: "Chine" },
    ...
    { code: "CP", label: "Île Clipperton" },
    { code: "AC", label: "Île de l'Ascension" },
    { code: "IM", label: "Île de Man" },
    { code: "NF", label: "Île Norfolk" },
    { code: "AX", label: "Îles Åland" },
    { code: "KY", label: "Îles Caïmans" },
    { code: "IC", label: "Îles Canaries" },
    { code: "CC", label: "Îles Cocos - Keeling" },
    { code: "CK", label: "Îles Cook" },
    { code: "FO", label: "Îles Féroé" },
    { code: "HM", label: "Îles Heard et MacDonald" },
    ...
    { code: "TC", label: "Îles Turks et Caïques" },
    ...
    { code: "QO", label: "régions éloignées de l’Océanie" },
    ...
    { code: "CS", label: "Serbie-et-Monténégro" },
    ...
    { code: "SJ", label: "Svalbard et Île Jan Mayen" },
    ...
    { code: "PS", label: "Territoire palestinien" },
